...
export const experiencesData = [
  ...
  },
  {
    ...
    company: 'Dexy AI',
    description:
      'At Dexy AI, I built responsive UIs using React.js and Next.js, integrated RESTful APIs for real-time data flow, and optimized performance through clean, maintainable code.',
    icon: React.createElement(FaReact),
...
export const projectsData = [
  {
    title: 'HireFlow',
    description:
      'An industry-level job portal featuring role-based access, company verification, and multi-step application tracking built with Next.js and Prisma.',
    tags: [
      'Next.js',
      'TypeScript',
      'Prisma',
...
export const skillsData = [
  ...
  },
  {
    ...
    icon: React.createElement(SiReacthookform),
  },
  {
    skill: 'NextAuth',
  ...
  {
    skill: 'Sonner',
    icon: React.createElement(IoMdNotifications),
  },
] as const;
